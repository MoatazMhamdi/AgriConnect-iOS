            ...
            .overlay(
                VStack {
                    ...
                    if showCommentButton {
                        NavigationLink(destination: CView(), isActive: $navigationLinkActive) {
                               EmptyView()
                           }// Affichage conditionnel du bouton de commentaire
                        Button(action: {
...
struct ContentBlogView_Previews: PreviewProvider {
